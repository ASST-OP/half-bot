...
await client.sendSquareMessage({ squareChatMid: "m6fb395949c79240780f37668e5f898a9", text: `[！]保護bot ver.4起動！
${currentDateTime}`});
...
async function checkAndSend() {
  ...
  await client.sendSquareMessage({ squareChatMid: "m6fb395949c79240780f37668e5f898a9", text: `[！]保護bot ver.4稼働中！
${currentTime}` });}
